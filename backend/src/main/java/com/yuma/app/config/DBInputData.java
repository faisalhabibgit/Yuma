...
//		ArrayList<Ingredients> ingredientsList1 = new ArrayList<Ingredients>();
//		ArrayList<Ingredients> ingredientsList2 = new ArrayList<Ingredients>();
//		ArrayList<Ingredients> ingredientsList3 = new ArrayList<Ingredients>();
//		ArrayList<Ingredients> ingredientsList4 = new ArrayList<Ingredients>();
//		ArrayList<Ingredients> ingredientsList5 = new ArrayList<Ingredients>();
//		//bogus ingredients
...
//		
//		
//		Meal meal1 = new Meal(ingredientsList1, UUID.randomUUID(), "chick broc", "chicken and broccolie topped with a touch of love", true, new HashSet<>());
//		Meal meal2 = new Meal(ingredientsList2, UUID.randomUUID(), "beef and rice", "beef and rice topped with a touch of love", true, new HashSet<>());
//		Meal meal3 = new Meal(ingredientsList3, UUID.randomUUID(), "fish and rice", "fish and rice topped with a touch of love", true, new HashSet<>());
//		Meal meal4 = new Meal(ingredientsList4, UUID.randomUUID(), "lamb", "lamb topped with a touch of love", true, new HashSet<>());
//		Meal meal5 = new Meal(ingredientsList5, UUID.randomUUID(), "pork", "topped with a touch of love", true, new HashSet<>());
//		Meal meal6 = new Meal(ingredientsList3, UUID.randomUUID(), "fish and rice", "fish and rice topped with a touch of love", false, new HashSet<>());
//		Meal meal7 = new Meal(ingredientsList2, UUID.randomUUID(), "chick broc", "chicken and broccolie topped with a touch of love", false, new HashSet<>());
//		Meal meal8 = new Meal(ingredientsList4, UUID.randomUUID(), "chick broc", "chicken and broccolie topped with a touch of love", false, new HashSet<>());
//		Meal meal9 = new Meal(ingredientsList5, UUID.randomUUID(), "chick broc", "chicken and broccolie topped with a touch of love", false, new HashSet<>());
//		Meal meal10 = new Meal(ingredientsList3, UUID.randomUUID(), "chick broc", "chicken and broccolie topped with a touch of love", false, new HashSet<>());
//
//		return strings -> {
