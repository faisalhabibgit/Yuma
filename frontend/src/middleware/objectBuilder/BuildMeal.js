...
class BuildMeal {
    ...
    getMealPromiseObj(apiPath) {
      ...
      switch (apiPath) {
        ...
        api = 'http://localhost:2020/api/meals/all';
        break;
       
        case 'api/meals/availablemeals':

        api = 'http://localhost:2020/api/meals/availablemeals';
              ...
              for (var i = 0; i < myJson.length; i++) {
                ...
                for (var j in obj.ingredients) {
                  ...
                  ingredients = new Ingredients(ingredientObj.name, ingredientObj.weight,
                    ingredientObj.calories, ingredientObj.price,ingredientObj.optional);
                  ingredientsList.push(ingredients);
                }

                meal = new Meal(obj.mealId, obj.name, obj.description, obj.isAvailable,
